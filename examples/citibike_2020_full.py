"""All 12 months of Citibike 2020 trip data unioned into a single expression."""
...
DATA_DIR = "/Users/paddy/xorq_mcp/data/citibike_2020/2020-citibike-tripdata"

con = xo.connect()

raw = con.read_csv(f"{DATA_DIR}/2020??-citibike-tripdata_*.csv", schema=schema)
